...
export default function Form(){
    ...
    return(
        ...
        >
            ...
            <button 
                type="submit" 
                className="flex items-center justify-center absolute right-2 mt-1 font-medium h-7 bg-teal-500/30 hover:bg-teal-500 text-neutral-900 dark:text-neutral-100 rounded w-16"
            >
            Send
            </button>
        </form>
