...
export default function Projects() {
    const data = [
        {id:0, title:'project1', desc: 'description 1', stack:[], img:imageUrl, link:'http://localhost:3000/projects'},
    ...
    return(
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <div>
                <div className='grid gap-2 grid-cols-8  lg:gap-5 p-2 place-items-center'>
                <svg
                    viewBox="0 0 32 32"
                    fill="currentColor"
                    className='w-8 h-8 text-black opacity-75 hover:opacity-100'
                    >
                    <path
                        fill="currentColor"
